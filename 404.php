...
<b style="width:20rem;height:5rem;position:absolute;bottom:1rem;left:50%;margin-left:-5rem;">
    <a href="<?php $this->options->rootUrl(); ?>" style="text-decoration:none;font-size:20px;color:#96999d;">Back to the Home Page</a>
</b>
</body>
</html>